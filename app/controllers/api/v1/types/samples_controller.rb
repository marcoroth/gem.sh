  ...
  module V1
    module Types
      class SamplesController < ApplicationController
        ...
        def sample_params
          params.expect(sample: [:gem_name, :gem_version, :receiver, :method_name, :application_name, :type_fusion_version, :location, { return_value: [], parameters: [] }]).tap do |whitelisted|
